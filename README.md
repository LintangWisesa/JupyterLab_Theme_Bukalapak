...
# JupyterLab Theme Inspired by Bukalapak

Hello Pelapak! Do you work with JupyterLab every single day while scroll at Bukalapak? If so, here I made a simple JupyterLab theme inspired by Bukalapak. Source code & setup instructions can be found on the link below. Hope you like it & let's collaborate if you have a new idea on this theme, PR on its GitHub repo.

- 📁 Source code 

    - Github repo: [JupyterLab Bukalapak Theme](https://github.com/LintangWisesa/JupyterLab_Theme_Bukalapak)

    - Preview:

        ![jupyterlab_BL](img/jupyterlab_bukalapak.png)
...
- Activate your JupyterLab:
    ...
    $ jupyter lab
    ```
- Go to _Settings > JupyterLab Theme_ then choose *JupyterLab Bukalapak*. Enjoy~ 😇
